<template>
	<div class="init-scroll">
		...
		<span v-show="loading" class="init-scroll-text">{{loadingText}}</span>
	</div>
</template>
...
<style>
.init-scroll{display: flex;justify-content: center;align-items: center;padding-bottom: 8px;line-height: 36px;width: 100%;}
.init-scroll-text {margin-left: 16px;font-size: 16px;}

.loader{width: 30px;height: 30px;position: relative;}
